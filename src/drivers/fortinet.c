...
static ushort fcstab[256] = {
	...
	0x7bc7, 0x6a4e, 0x58d5, 0x495c, 0x3de3, 0x2c6a, 0x1ed1, 0x0f58
};
...
fortinet_read_packet(VpnSession *s, uchar *buf, int maxlen)
{
	...
	/* TRADUÇÃO: PPP Raw da Fortinet -> HDLC assincrono enquadrado p/ ip/ppp -f */
	{
...
fortinet_write_packet(VpnSession *s, uchar *buf, int len)
{
	...
	/* Fortinet usa PPP raw: tira addr/ctl FF 03 do HDLC, se presente */
